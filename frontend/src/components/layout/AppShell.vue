<template>
  <div class="flex h-screen min-h-0 flex-col overflow-hidden bg-zinc-50 text-zinc-900 print:h-auto print:overflow-visible print:bg-white">
    ...
    <div class="grid min-h-0 flex-1 grid-cols-[18rem_minmax(0,1fr)] border-t border-zinc-200 print:block print:overflow-visible print:border-none">
      <LeftNav class="print:hidden" />
      <main class="min-h-0 min-w-0 overflow-hidden print:overflow-visible">
